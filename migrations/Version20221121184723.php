 ...
 */
final class Version20221121184723 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book ADD slug VARCHAR(255) NOT NULL, ADD image VARCHAR(255) NOT NULL, ADD meap TINYINT(1) NOT NULL, ADD authors LONGTEXT NOT NULL COMMENT \'(DC2Type:simple_array)\', ADD date DATE NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book DROP slug, DROP image, DROP meap, DROP authors, DROP date');
    }
}
